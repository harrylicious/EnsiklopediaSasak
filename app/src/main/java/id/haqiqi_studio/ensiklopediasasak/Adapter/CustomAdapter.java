 ...
 */
public class CustomAdapter extends ArrayAdapter<ModelKata> implements View.OnClickListener{
    ...
    public CustomAdapter(ArrayList<ModelKata> data, Context context) {
        super(context, R.layout.custom_row, data);
        ArrayList<ModelKata> dataSet = data;
    ...
    public void onClick(View v) {
        ...
        ModelKata dataModel=(ModelKata)object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ModelKata dataModel = getItem(position);
