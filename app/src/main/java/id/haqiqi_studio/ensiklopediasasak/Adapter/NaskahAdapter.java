 ...
 */
public class NaskahAdapter extends ArrayAdapter<ModelNaskah> implements View.OnClickListener{
    ...
    public NaskahAdapter(ArrayList<ModelNaskah> data, Context context) {
        super(context, R.layout.custom_row, data);
        ArrayList<ModelNaskah> dataSet = data;
    ...
    public void onClick(View v) {
        ...
        ModelNaskah dataModel=(ModelNaskah)object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ModelNaskah dataModel = getItem(position);
        ...
        viewHolder.txtForm.setText(dataModel.getPenulis());
        viewHolder.txtWord.setText(String.valueOf(dataModel.getJmlHalaman()));
